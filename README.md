...
Tic-tac-toe game improvements (listed in increasing difficulty):
...
4. Add a toggle button that lets you sort the moves in either ascending or descending order. [IN PROGRESS]
